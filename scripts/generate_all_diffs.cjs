...
console.log('Total decrees to populate in DIFF_DATABASE:', decrees.length);

// Let's create an accurate, comprehensive legal diff dataset for ALL 55 documents
const allDiffs = {
  // 1. tt-99-2025
  'tt-99-2025': {
    decreeId: 'tt-99-2025',
...
console.log('Total entries defined in allDiffs:', Object.keys(allDiffs).length);

// Generate component code
const compTemplate = `import React, { useState } from 'react';
...
export const DIFF_DATABASE: Record<string, DecreeDiffData> = ${JSON.stringify(allDiffs, null, 2)};
    ...
    <div className="space-y-6">
      ...
      <div className="bg-card border border-border p-4 rounded-xl shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        >
          ...
          <optgroup label="4. Hợp đồng xây dựng & Chi phí đầu tư (6 văn bản)">
...
fs.writeFileSync('src/components/decree/DecreeDiffViewer.tsx', compTemplate, 'utf8');
console.log('Successfully wrote DecreeDiffViewer.tsx with ALL 55 DOCUMENTS!');
