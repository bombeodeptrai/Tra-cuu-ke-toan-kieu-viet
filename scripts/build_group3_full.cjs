...
// tt-219-2013: 14 points
g3['tt-219-2013'].items = [
  {
...
// tt-111-2013: 12 points
g3['tt-111-2013'].items = [
  {
...
// nd-180-2024-nd-cp: 10 points
g3['nd-180-2024-nd-cp'].items = [
  {
...
console.log('Group 3 fully expanded! Decrees count:', Object.keys(g3).length);
