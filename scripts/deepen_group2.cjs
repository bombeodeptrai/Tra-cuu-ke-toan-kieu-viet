...
fs.writeFileSync('src/data/diffs/group2_invoices_tax_admin.ts', 
  `import { DecreeDiffData } from '../diff-types';\n\nexport const group2InvoicesTaxAdmin: Record<string, DecreeDiffData> = ${JSON.stringify(group2, null, 2)};\n`, 
  'utf8'
);
console.log('Group 2 updated with deep legal citations, numbers, and accounts!');
