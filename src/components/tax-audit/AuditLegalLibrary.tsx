...
export function AuditLegalLibrary(){
  ...
  return <section className="border rounded-xl p-4 space-y-4 bg-card">
    ...
    <div className="rounded border p-3 text-sm">Cần kiểm theo kỳ: nguồn gốc lâm sản và định mức nội thất; GTGT đầu vào và thanh toán; hóa đơn; thuế TNDN; giao dịch liên kết; quyền và phạm vi kiểm tra. Danh mục bổ sung đang rà soát chuỗi sửa đổi, chưa phải xác nhận đủ mọi căn cứ cho kỳ chưa biết.</div>
