# Nghị định 123/2020/NĐ-CP quy định về Hóa đơn, Chứng từ (123/2020/NĐ-CP)

## 🌟 TÓM TẮT CHUYÊN SÂU (Bởi AI)
# TÓM TẮT CHUYÊN SÂU: NGHỊ ĐỊNH 123/2020/NĐ-CP DÀNH CHO KẾ TOÁN

Nghị định 123/2020/NĐ-CP là văn bản pháp lý nền tảng xác lập cơ chế quản lý, sử dụng **Hóa đơn điện tử (HĐĐT) và Chứng từ điện tử** diện rộng, thay thế hoàn toàn các quy định cũ về hóa đơn giấy. 

Dưới đây là các điểm mấu chốt kế toán viên bắt buộc phải nắm vững:

---

### 1. Nguyên tắc xuất hóa đơn: Bao phủ mọi nghiệp vụ phát sinh
Điều 4 Nghị định 123 quy định nguyên tắc nguyên bản: **Mọi trường hợp bán hàng hóa, cung cấp dịch vụ đều phải xuất hóa đơn** và tuân thủ chuẩn định dạng dữ liệu của cơ quan thuế (CQT). 

Kế toán lưu ý các trường hợp **bắt buộc phải lập hóa đơn** mà doanh nghiệp thường bỏ sót:
...
* Hàng hóa **tiêu dùng nội bộ** (trừ luân chuyển nội bộ để tiếp tục quá trình sản xuất).
* Xuất hàng hóa dưới hình thức **cho vay, cho mượn hoặc hoàn trả**.

---

### 2. Phân loại Hóa đơn & Chứng từ điện tử
* **Hóa đơn điện tử:** Bao gồm loại *có mã của CQT*, *không có mã của CQT*, và *HĐĐT khởi tạo từ máy tính tiền* có kết nối dữ liệu với CQT.
* **Chứng từ điện tử:** Áp dụng cho chứng từ khấu trừ thuế TNCN, biên lai thu thuế, phí, lệ phí.
* **Hình thức tiêu hủy:** Tiêu hủy HĐĐT là làm cho dữ liệu không còn tồn tại trên hệ thống, không thể truy cập hay tham chiếu; khác biệt hoàn toàn với hình thức xé/đốt đối với hóa đơn giấy đặt in.

---

### 3. Nhận diện rủi ro pháp lý: Phân biệt "Không hợp pháp" (Điều 3)
Kế toán cần phân biệt rõ hai khái niệm để quản trị rủi ro chi phí được trừ khi tính thuế TNDN và khấu trừ thuế GTGT:

* **Sử dụng hóa đơn, chứng từ không hợp pháp (Bản chất hóa đơn sai phạm):**
  * Hóa đơn giả; hóa đơn hết giá trị hoặc chưa có giá trị sử dụng; hóa đơn bị ngừng sử dụng do cưỡng chế thuế.
  * HĐĐT chưa đăng ký với CQT hoặc chưa được cấp mã (đối với đối tượng phải dùng hóa đơn có mã).
  * Hóa đơn mua vào có ngày lập **sau thời điểm** CQT đã thông báo bên bán không hoạt động tại địa chỉ đăng ký.

* **Sử dụng không hợp pháp hóa đơn, chứng từ (Hành vi/Nghiệp vụ sai phạm):**
  * **Hóa đơn khống:** Lập hóa đơn nhưng không có thực tế mua bán hàng hóa, dịch vụ.
  * Hóa đơn phản ánh sai giá trị thực tế; hóa đơn bị tẩy xóa, sửa chữa.
  * Hóa đơn "quay vòng" khi vận chuyển hàng hóa lưu thông; dùng hóa đơn hàng hóa này cho hàng hóa khác.
  * Sử dụng hóa đơn của bên khác để hợp thức hóa hàng hóa mua vào/bán ra.

---

### 💡 LƯU Ý TRỌNG YẾU CHO KẾ TOÁN KHI ÁP DỤNG
1. **Kiểm tra trạng thái doanh nghiệp:** Thường xuyên tra cứu tra cứu trạng thái hoạt động của nhà cung cấp trên Cổng thông tin của CQT trước khi hạch toán hóa đơn đầu vào.
2. **Kiểm tra định dạng dữ liệu:** Đảm bảo HĐĐT nhận được là file dữ liệu gốc (định dạng `.XML`), không chỉ lưu trữ bản thể hiện (`.PDF`).
3. **Đồng bộ Chứng từ thuế TNCN:** Chuyển đổi hoàn toàn sang chứng từ khấu trừ thuế TNCN điện tử theo quy định.
...
_Hà Nội, ngày 19 tháng 10 năm 2020_
...
**Mục 3  
HÓA ĐƠN DO CƠ QUAN THUÊ ĐẶT IN**
...
**Chương IV  
XÂY DỰNG, TRA CỨU THÔNG TIN HÓA ĐƠN, CHÚNG TỪ**
...
<table border="1" style="border-collapse: collapse; width: 100%; border-width: 1px; border-style: hidden;"><colgroup><col style="width: 50%;"> <col style="width: 50%;"></colgroup><tbody><tr><td style="text-align: center; border-style: hidden;"></td><td style="text-align: center; border-style: hidden;"><p style="font-family: 'Times New Roman', Times, serif;"><span style="font-family: 'times new roman', times, serif; font-size: 14px;"><strong>TM. CHÍNH PHỦ</strong></span></p><p style="font-family: 'Times New Roman', Times, serif;"><span style="font-family: 'times new roman', times, serif; font-size: 14px;"><strong>THỦ TƯỚNG</strong></span></p><p style="font-family: 'Times New Roman', Times, serif;"><span style="font-family: 'times new roman', times, serif; font-size: 14px;"><em><strong>(đã ký)</strong></em></span></p><p style="font-family: 'Times New Roman', Times, serif;"><span style="font-family: 'times new roman', times, serif; font-size: 14px;"><strong>Nguyễn Xuân Phúc</strong></span></p></td></tr></tbody></table>